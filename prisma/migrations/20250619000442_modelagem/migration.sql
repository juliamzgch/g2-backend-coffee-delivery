-- CreateEnum
CREATE TYPE "Status" AS ENUM ('abandonado', 'aguardandoPagamento', 'finalizado');

-- CreateEnum
CREATE TYPE "StatusPayment" AS ENUM ('aprovado', 'analise', 'pendente', 'cancelado');
...
CREATE TABLE "Cart" (
    "id" TEXT NOT NULL,
    "userId" TEXT,
    "status" "Status" NOT NULL DEFAULT 'aguardandoPagamento',
    "statusPayment" "StatusPayment" NOT NULL DEFAULT 'pendente',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
